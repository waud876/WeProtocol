...
func (z *ZT) Init() {
	...
	saeBytes, err := baseutils.ReadFile("08sae.dat")
	if err != nil {
		baseutils.PrintLog("ZT initSaeInfo err: " + err.Error())
		return
	}
	proto.Unmarshal(saeBytes, saePB)
	z.ver = saePB.GetVer()
	z.initKey = saePB.GetInitKey() //pb2
	z.totalSize = saePB.GetTotalSize()
	z.xorKey1 = saePB.GetXorKey1()                          //pb9  128
	z.key1 = baseutils.SaePb10T(saePB.GetKey1(), z.xorKey1) //pb10
	z.xorKey2 = saePB.GetXorKey2()                          //pb11  64
	z.key2 = baseutils.SaePb12T(saePB.GetKey2(), z.xorKey2) //pb12
	z.key3 = saePB.GetKey3()                                //pb18
}
