...
// @Success 200
// @router /UpdateStepNumberApi [post]
...
// @Summary OauthSdkApp
// @Param	body			body	Tools.OauthSdkAppParam	 true		""
// @Failure 200
...
// @Summary UploadAppAttachApi
// @Param	body			body	Tools.UploadAppAttachModel
// @Failure 200
// @router /UploadAppAttachApi [post]
func (c *ToolsController) UploadAppAttachApi() {
	var Data Tools.UploadAppAttachModel
	err := json.Unmarshal(c.Ctx.Input.RequestBody, &Data)
	if err != nil {
		Result := models.ResponseResult{
			Code:    -8,
	...
	result := Tools.UploadAppAttachService(Data.Wxid, Data)
	c.Data["json"] = &result
	c.ServeJSON()
}
